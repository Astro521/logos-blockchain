...
mod tests {
    ...
    fn test_sync() {
        ...
        let genesis_ledger = LedgerState::from_utxos([], &ledger_config(), 1.into(), 1.into());
    ...
    fn test_fund_tx_with_change() {
        ...
        let ledger_state =
            LedgerState::from_utxos([alice_utxo], &ledger_config(), 1.into(), 1.into());
    ...
    fn test_fund_tx_zero_funds() {
        let alice = pk(1);
        let ledger_state = LedgerState::from_utxos([], &ledger_config(), 1.into(), 1.into());
